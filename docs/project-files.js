...
const fileGroups = [
  ...
  ['API Service 与 Worker', [
    ...
    ['apps/api/src/services/message.service.ts', '消息去重、入库、同正文短时去重、摘要、outbound 确认和草稿关闭。', 'RPA outbound、ReplyDraft。'],
  ...
  ['RPA 与 Chrome 插件', [
    ...
    ['extensions/customer-ai-rpa/content.js', 'DOM 采集、稳定 messageId、未读队列、历史咨询 Tab 暂停、回填发送。', '平台 DOM 与串话防护。'],
