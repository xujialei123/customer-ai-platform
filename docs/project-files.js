...
const fileGroups = [
  ...
  ['API Adapter 与路由', [
    ...
    ['apps/api/src/routes/logs.ts', 'RPA 排查日志页与 /logs/recent API（内存环 + 文件兜底）。', 'terminal-log、rpa-logs.html。'],
    ['packaging/windows-portable/rpa-logs.html', '浏览器打开的 RPA 业务日志排查页。', '/logs 路由、terminalLog 事件。'],
  ...
  ['API Service 与 Worker', [
    ...
    ['apps/api/src/services/safety.service.ts', '高风险关键词/寒暄豁免、非寒暄空召回转人工、禁止承诺和自动发送判定。', 'AGENTS 风控、handoff。'],
    ...
    ['apps/api/src/utils/terminal-log.ts', '终端彩色业务日志 + 内存环缓冲；供 /logs 排查页。', 'ReplyWorker、gateway、rpa-logs.html。'],
  ...
  ['RPA 与 Chrome 插件', [
    ...
    ['extensions/customer-ai-rpa/manifest.json', 'MV3 权限、域名和脚本声明。', '版本与权限；详解见 docs/extension-rpa-files.html。'],
    ['extensions/customer-ai-rpa/platform-profiles.js', '美团/抖音默认选择器与 URL 平台识别、合并 storage。', 'content.js、popup.js。'],
  ...
  ['数据库、共享包与交付', [
    ...
    ['scripts/build-windows-portable.ps1', '组装 Windows 便携包：Node、扩展、文档、Prisma CLI；可选/强制 docker save 镜像（不捆绑 OpenClaw）。', 'runtime/docker-images、release、package:windows:handoff。'],
    ...
    ['packaging/windows-portable/Start-Customer-AI.ps1', '便携一键启动：包内镜像 docker load、compose 起库、空库 migrate、RAG/API；非 openclaw 跳过网关。', 'runtime/docker-images、prisma/migrations、/guide。'],
    ['scripts/bundle-portable-docker-images.ps1', '向已有便携包补打 Postgres/Redis 镜像 tar。', 'Start docker load、handoff 交付。'],
  ...
  ['后台、文档、样例与生成物', [
    ...
    ['docs/extension-rpa-files.html', 'customer-ai-rpa 逐文件功能与代码位置索引。', 'manifest、content、background、popup、platform-profiles。'],
    ['docs/extension-rpa-logic.html', '按实际链路讲解插件各文件逻辑与 if 分支判断。', 'extension-rpa-files、extension-rpa-flow。'],
